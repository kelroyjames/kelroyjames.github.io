...
Supply chain assurance and GRC specialist with 18 years of Defence logistics experience, delivering measurable outcomes in high-stakes environments. Expert in closing the gap between records and physical reality through systematic controls, risk-based auditing, and enterprise-level process improvement.

**Core Capabilities:** Supply chain assurance | Financial control recovery | Dangerous goods compliance | Third-party risk management | ISO 27001/42001/27701 audit | Inventory & asset management | Export control | Digital transformation

**Proven Impact:** £2.4M financial misallocation corrected | £250K lean maintenance savings | 100% compliance achievement rate | 3 control artefacts adopted fleet-wide | 80% financial liability reduction
...
- Identified and corrected £2.4M in misallocated expenditure through systematic analysis of spending patterns and ledger-to-reality reconciliation
- Conducted root cause analysis leading to Navy-wide policy instruction to prevent recurrence
- Developed 3 control artefacts (stock variance protocol, custody transfer checklist, expenditure reconciliation template) adopted across Type 45 fleet
- Reduced financial liability by 80% through asset verification and documentation remediation

**Digital Transformation & Data Analytics**
- Co-developed fleet-wide inventory interrogation application in Palantir Foundry with DE&S and prime contractor teams
- Designed ground-truth validation protocols and real-time visibility dashboards scoped for enterprise rollout
- Integrated legacy inventory systems with modern data platform, enabling cross-platform analytics
...
- **Percy Hobart Fellowship** | Digital Transformation | 2022
- **AWS Community Builder** | Fourth consecutive year | Cloud architecture & data engineering

---

## AWARDS & RECOGNITION

- **Royal Navy Inclusivity Award for Innovation** | 2023 | Inaugural recipient for junior rates development programme
...
- **VINLEC Employee of the Year** | St Vincent Electricity Services | Operational excellence in infrastructure planning
...
**Rob Jones CEng MIET FCMI** | Project Manager, Thales (Former Officer in Charge, Fleet Diving Squadron HQ)

> "Of all the logistics specialists I worked with over 12 years if I could select one to support my engineers on the ground it would be Kelroy. His application of the defence procurement model and capability to network with all stakeholders to achieve the required outcome is second to none. If you have critical logistics needs, this is the man you need to manage it!"
